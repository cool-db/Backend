    ...
    public class ScheduleBiz
    {
        public static object CreateSchedule(object json)
        {
            ...
            using (var context = new BackendContext())
            {
                ...
                //check permission
                if (!Helper.CheckPermission(projectId, creatorId, queryProject.Single().OwnerId == creatorId, OperationType.POST))
        ...
        public static object DeleteSchedule(object json)
        {
            ...
            using (var context = new BackendContext())
            {
                ...
                if (!Helper.CheckPermission(queryProject.Single().Id, operatorId, queryProject.Single().OwnerId == operatorId, OperationType.DELETE))
        ...
        public static object UpdateSchedule(object json)
        {
            ...
            using (var context = new BackendContext())
            {
                ...
                if(!Helper.CheckPermission(projectId, operatorId, queryProject.Single().OwnerId == operatorId, OperationType.PUT))
                    return Helper.BuildResult(null, 401, "用户无操作权限");
        ...
        public static object AddParticipator(object json)
        {
            ...
            using (var context = new BackendContext())
            {
                ...
                //check permission
                if (!Helper.CheckPermission(theSchedule.ProjectId, operatorId, queryProject.Single().OwnerId == operatorId, OperationType.POST))
        ...
        public static object DeleteParticipator(object json)
        {
            ...
            using (var context = new BackendContext())
            {
                ...
                if(!Helper.CheckPermission(theSchedule.ProjectId, operatorId, queryProject.Single().OwnerId == operatorId, OperationType.DELETE))
                    return Helper.BuildResult(null, 401, "用户无操作权限");
